...
1. **Headline** — the structured status line the skill already owns (`OUTCOME:`, `AUTOPILOT:`, `REVIEW:`, `ADVERSARY:`, `RETRO:`). Grammar unchanged, machine-parseable; each skill's own file owns its grammar.
