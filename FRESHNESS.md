...
| `skills/utils/investigate/LEDGER-FORMAT.md` | `/afk:investigate` | a ledger table, a field, a status set, the verdict rule, the fragment grammar, the file names, the location rule, or the report/reply shape changes — the emitter `skills/utils/investigate/scripts/seed_map.py`, the parser `skills/utils/investigate/scripts/validate_coverage.py`, and `scripts/tests/test_validate_coverage.py` move in the same commit |
| `skills/utils/investigate/scripts/` (`seed_map.py`, `validate_coverage.py`) | `/afk:investigate` | the seed-map JSON shape, a default boundary pattern, a name-form rule, or a validation rule changes — `skills/utils/investigate/LEDGER-FORMAT.md`, `scripts/tests/test_seed_map.py` and `scripts/tests/test_validate_coverage.py` move in the same commit |
