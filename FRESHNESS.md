...
| `providers/codex/agents/*.toml` | plugin author | an `agents/*.md` role is added, removed, renamed, or changes model/sandbox needs — keep pointer-only stubs; `/afk:setup` copies them unchanged |
