...
1. the component's code and its `AGENTS.md`
...
- **Correction without a home.** A claim corrected only in a review record, with no spec, ADR, `AGENTS.md`, or code change behind it, will be re-derived by the next reader. Report it (`class: spec`) naming where the correction belongs.
