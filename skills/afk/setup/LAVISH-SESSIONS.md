...
re-render each round, tooltips, queue discipline, fallback. A skill carrying
its own render point keeps its own weave; this section covers the grilling
sessions no skill weave reaches.
